...
function assertPersistentStorage() {
  if (IS_PRODUCTION && !USE_KV) {
    throw new Error('Persistent user storage is not configured. Add UPSTASH_REDIS_REST_URL and UPSTASH_REDIS_REST_TOKEN in Vercel so free credits stay tied to email.');
  }
}
